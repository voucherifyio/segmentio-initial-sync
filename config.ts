...
export const SEGMENT_REQUEST_LIMIT = process.env.SEGMENT_REQUEST_LIMIT ? process.env.SEGMENT_REQUEST_LIMIT : throwMissingVariableError('SEGMENT_REQUEST_LIMIT');
export const SEGMENT_TRAITS_LIMIT = process.env.SEGMENT_TRAITS_LIMIT ? process.env.SEGMENT_TRAITS_LIMIT : throwMissingVariableError('SEGMENT_TRAITS_LIMIT');
